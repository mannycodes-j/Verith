export const appShellStyles = {
  ...
  topbarActions:
    "flex items-center gap-2.5 [&>a]:min-h-11 [&>a]:rounded-full [&>a]:border [&>a]:border-white/10 [&>a]:bg-white/[0.04] [&>a]:px-4 [&>a]:py-2.5 [&>a]:text-xs [&>a]:font-medium [&>a:hover]:border-white/15 [&>a:hover]:bg-white/[0.08] [&>a:last-of-type]:border-0 [&>a:last-of-type]:bg-gradient-to-r [&>a:last-of-type]:from-[#C084FC] [&>a:last-of-type]:to-[#6366F1] [&>a:last-of-type]:text-white max-sm:[&>a]:hidden",
  notificationTrigger:
    "min-h-11 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2.5 text-xs font-medium transition-colors hover:border-white/15 hover:bg-white/[0.08] max-sm:hidden",
  mobileNavigation:
