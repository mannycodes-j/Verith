export const verificationHistoryStyles = {
  ...
  header:
    "grid grid-cols-[1fr_minmax(18rem,0.45fr)] gap-8 py-[clamp(3rem,6vw,6rem)] max-[760px]:grid-cols-1 [&>span]:col-span-full [&>span]:font-mono [&>span]:text-[0.6rem] [&>span]:tracking-[0.16em] [&>span]:text-accent [&>span]:uppercase max-[760px]:[&>span]:col-span-1 [&_h1]:m-0 [&_h1]:text-[clamp(3rem,6vw,6rem)] [&_h1]:leading-[0.98] [&_h1]:font-semibold [&_h1]:tracking-[-0.055em] [&_p]:m-0 [&_p]:self-end [&_p]:leading-[1.6] [&_p]:text-muted-foreground",
  filters:
  ...
  list: "overflow-hidden rounded-xl border border-white/[0.08] bg-[#050505]",
  listHeader:
  ...
  record:
    "grid grid-cols-[minmax(0,1.5fr)_0.6fr_0.7fr_0.7fr_auto] items-center gap-5 border-b border-white/[0.07] px-4 py-5 transition-colors hover:bg-white/[0.025] max-[760px]:grid-cols-[1fr_auto] [&>div]:min-w-0 [&>div>span]:block [&>div>span]:font-mono [&>div>span]:text-[0.58rem] [&>div>span]:text-muted [&>div>span]:uppercase [&_strong]:block [&_strong]:truncate [&_strong]:text-base [&_strong]:font-medium [&>span]:font-mono [&>span]:text-[0.58rem] [&>span]:text-muted [&>span]:uppercase max-[760px]:[&>span]:hidden [&>a]:font-mono [&>a]:text-[0.58rem] [&>a]:text-accent [&>a]:uppercase",
  loading:
