export const reportStyles = {
  report: "border border-border-strong bg-background",
  reportHeader:
    "grid grid-cols-[minmax(0,1.2fr)_minmax(18rem,0.45fr)] gap-[clamp(2rem,6vw,6rem)] p-[clamp(2rem,6vw,6rem)] max-[800px]:grid-cols-1 [&>div>span]:font-mono [&>div>span]:text-[0.58rem] [&>div>span]:tracking-[0.07em] [&>div>span]:text-muted [&>div>span]:uppercase [&_h2]:my-5 [&_h2]:font-editorial [&_h2]:text-[clamp(4rem,8vw,8rem)] [&_h2]:leading-[0.88] [&_h2]:font-normal [&_h2]:tracking-[-0.065em] [&_p]:leading-[1.65] [&_p]:text-muted-foreground [&_dl]:m-0 [&_dl_div]:grid [&_dl_div]:grid-cols-2 [&_dl_div]:gap-4 [&_dl_div]:border-t [&_dl_div]:border-border [&_dl_div]:py-3 [&_dt]:font-mono [&_dt]:text-[0.58rem] [&_dt]:text-muted [&_dt]:uppercase [&_dd]:m-0 [&_dd]:text-right [&_dd]:text-[0.7rem]",
  findings:
  ...
  limitations:
    "bg-foreground p-[clamp(2rem,6vw,6rem)] text-background [&>span]:font-mono [&>span]:text-[0.58rem] [&>span]:uppercase [&_h2]:font-editorial [&_h2]:text-[clamp(3rem,6vw,6rem)] [&_h2]:font-normal [&_ol]:pl-5 [&_li]:py-2 [&_li]:leading-[1.6] [&_li]:text-background/75 [&_p]:leading-[1.6] [&_p]:text-background/75",
  reportLoading:
