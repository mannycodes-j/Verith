...
export const workspaceStyles = {
  ...
  composerEntry:
    `${ui.card} flex min-h-52 items-center justify-between gap-8 [background:radial-gradient(circle_at_15%_0%,rgba(139,92,246,0.15),transparent_25rem),rgba(7,7,8,0.72)] p-7 max-md:flex-col max-md:items-start [&>div:first-child>span]:text-[10px] [&>div:first-child>span]:font-semibold [&>div:first-child>span]:uppercase [&>div:first-child>span]:tracking-[0.14em] [&>div:first-child>span]:text-violet-400 [&_h2]:mt-4 [&_h2]:mb-0 [&_h2]:max-w-[24ch] [&_h2]:text-3xl [&_h2]:font-semibold [&_h2]:tracking-tight md:[&_h2]:text-4xl [&_a]:rounded-full [&_a]:bg-gradient-to-r [&_a]:from-[#C084FC] [&_a]:to-[#6366F1] [&_a]:px-6 [&_a]:py-3.5 [&_a]:text-sm [&_a]:font-medium [&_a]:text-white [&_a]:transition-transform [&_a:hover]:scale-[1.02]`,
  overviewGrid:
    "mt-6 grid grid-cols-[minmax(0,1fr)_360px] gap-6 max-[1280px]:grid-cols-1 [&>section]:relative [&>section]:min-h-96 [&>section]:overflow-hidden [&>section]:rounded-3xl [&>section]:border [&>section]:border-white/[0.06] [&>section]:bg-card/60 [&>section]:p-6 [&>section]:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] [&>aside]:relative [&>aside]:min-h-96 [&>aside]:overflow-hidden [&>aside]:rounded-3xl [&>aside]:border [&>aside]:border-white/[0.06] [&>aside]:bg-card/60 [&>aside]:p-6 [&>aside]:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)]",
  sectionHeader:
  ...
  recentList:
    "m-0 grid list-none gap-3 p-0 [&_a]:grid [&_a]:grid-cols-[minmax(0,1fr)_minmax(21rem,1.1fr)] [&_a]:items-center [&_a]:gap-6 [&_a]:rounded-2xl [&_a]:border [&_a]:border-white/[0.04] [&_a]:bg-white/[0.02] [&_a]:p-4 [&_a]:transition-all [&_a:hover]:-translate-y-0.5 [&_a:hover]:border-white/10 [&_a:hover]:bg-white/[0.04] max-[1280px]:[&_a]:grid-cols-1 [&_a>div]:grid [&_a>div]:min-w-0 [&_a>div]:gap-2 [&_a:hover_strong]:text-violet-300 [&_span]:font-mono [&_span]:text-[10px] [&_span]:text-white/30 [&_strong]:truncate [&_strong]:text-sm [&_strong]:font-medium [&_strong]:transition-colors [&_dl]:m-0 [&_dl]:grid [&_dl]:grid-cols-[0.6fr_0.8fr_0.5fr_1.2fr] [&_dl]:gap-4 max-md:[&_dl]:grid-cols-2 [&_dl_div]:grid [&_dl_div]:min-w-0 [&_dl_div]:gap-1 [&_dt]:text-[10px] [&_dt]:uppercase [&_dt]:tracking-[0.1em] [&_dt]:text-white/30 [&_dd]:m-0 [&_dd]:truncate [&_dd]:text-xs [&_dd]:capitalize",
  principles:
