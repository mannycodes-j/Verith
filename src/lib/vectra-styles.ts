export const vectraStyles = {
  ...
  primaryAction:
    "rounded-full border-0 bg-gradient-to-r from-[#C084FC] to-[#6366F1] px-5 py-3 text-sm font-medium text-white transition-all duration-200 hover:scale-[1.02] hover:shadow-[0_12px_28px_-10px_rgba(139,92,246,0.4)] active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50",
  secondaryAction:
    "rounded-full border border-white/10 bg-white/[0.04] px-5 py-3 text-sm font-medium text-foreground transition-all duration-200 hover:border-white/15 hover:bg-white/[0.08] active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50",
  state:
